...
from alam_ask import grounded_answer, grounded_sources, rank_records, relevance_score

VISA = {
    "id": "visa-fee", "_category": "practical", "title": "Japan visa renewal fees change in October",
    "summary": "Residence renewal costs rise from October.", "why_it_matters": "Foreign residents may pay more.",
    "tags": ["Japan", "Visa Renewal", "Immigration"], "importance": 98, "confidence": 99,
    "content": {"key_message": "File only when your residence application is genuinely ready.", "reading_levels": {"30 sec": {"bottom_line": "Check the official filing window."}}},
    "sources": [
        {"publisher": "Immigration Services Agency of Japan", "title": "Official fee notice", "url": "https://www.moj.go.jp/isa/example.html", "source_type": "official"},
        {"publisher": "Duplicate", "title": "Duplicate URL", "url": "https://www.moj.go.jp/isa/example.html"},
        {"publisher": "Unsafe", "title": "Unsafe", "url": "javascript:alert(1)"},
    ],
}
