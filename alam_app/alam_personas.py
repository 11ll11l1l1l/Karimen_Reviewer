    ...
    "reflection": [
        {
            ...
            "role": "Meaning Maker",
            "pole": "synthesize",
            "tagline": "Okay, pero anong sinasabi nito tungkol sa tao?",
            "description": "Empathetic, psychologically curious and willing to sit with ambiguity, philosophy and faith.",
        },
        {
            "id": "tomas-kontra",
            "name": "Tomas Kontra",
            "emoji": "🥊",
            "role": "Socratic Contrarian",
            "pole": "challenge",
            "tagline": "Maganda pakinggan. Pero paano kung baliktad?",
            "description": "Tests comforting narratives, religious shortcuts and philosophical assumptions with strong counterarguments.",
        },
    ],
    "practical": [
        {
