...
-- Safe to run repeatedly where noted. Existing public `agents` table is preserved.
...
create table if not exists public.articles (
  ...
  title text not null,
  summary text,
  status text not null default 'draft' check (status in ('draft','published','developing','updated','resolved','outdated','rejected','archived')),
...
-- Agent ingestion should use a trusted server-side service role or Edge Function.
