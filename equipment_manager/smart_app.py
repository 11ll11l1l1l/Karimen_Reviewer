...
class SmartMainWindow(QMainWindow):
    def __init__(self, db: Database, user):
        ...
        self.quick_create=QPushButton("Report Issue")
        self.quick_create.setToolTip("Report a manual equipment issue or create an engineering work order (Ctrl+N)")
        ...
        create_action=QAction("Report Issue",self);create_action.setShortcut(QKeySequence("Ctrl+N"));create_action.triggered.connect(self.open_quick_create);self.addAction(create_action)
